    ...
    <div className="bg-white sticky top-0 z-50  "  >
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" >
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === 'alexandrapaun@gmail.com' ? <div className="flow-root">
                    <Link to={'/ecommerce-react-firebase/dashboard/'} className="-m-2 block p-2 font-medium text-gray-900">
                      Admin
                    </Link>
                  </div> : ""}
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-blue-500 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
          Get free delivery on orders over  €40
        </p>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  {user?.user?.email === 'alexandrapaun@gmail.com'?
                   <Link to={'/ecommerce-react-firebase/dashboard'} className="text-sm font-medium text-gray-700 ">
                    Admin
                  </Link> : ""
                }
                  ...
                  {user ? <a onClick={logout} className="text-sm font-medium text-gray-700 cursor-pointer  ">
                    Logout
                  </a> : <Link to={'/ecommerce-react-firebase/signup'} className="text-sm font-medium text-gray-700 cursor-pointer  ">
                    Signup
                  </Link>}
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Link to={'/ecommerce-react-firebase/cart'} className="group -m-2 flex items-center p-2" >
