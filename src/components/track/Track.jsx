            ...
            <section>
                <div className=" container mx-auto px-5 md:py-5">
                    <div className="flex flex-wrap -m-4 text-center">
                        ...
                        <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                            <div className="border-2 hover:shadow-xl hover:shadow-gray-200 border-gray-200 bg-gray-100 shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] px-4 py-6 rounded-lg" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                               <LiaShippingFastSolid className="text-blue-600 w-12 h-12 mb-3 inline-block" ></LiaShippingFastSolid>

                                <h2 className="title-font font-medium text-lg text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>Shipping Fast</h2>
                                <p className="leading-relaxed">3 Transit providers. <br></br>100+ Peers.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                            <div className="border-2 hover:shadow-xl hover:shadow-gray-200 border-gray-200 bg-gray-100 shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] px-4 py-6 rounded-lg" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                <MdOutlineSupportAgent  className="text-blue-600 w-12 h-12 mb-3 inline-block" ></MdOutlineSupportAgent>
                                <h2 className="title-font font-medium text-lg text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>Support</h2>
                                <p className="leading-relaxed"> Get access to instant support from helpful humans.
                                </p>
                            </div>
                        </div>
