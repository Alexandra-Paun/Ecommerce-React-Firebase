                        ...
                        <TabPanel>
                            <div className='  px-4 md:px-0 mb-16'>
                                ...
                                <div className=" flex justify-end">
                                   <Link to={'/ecommerce-react-firebase/addproduct'}>
                                   <button
                                        type="button"
                                        className="focus:outline-none text-white bg-blue-500 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-pink-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" > <div className="flex gap-2 items-center">
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className=" flex gap-2">
                                                        <div className=" flex gap-2 cursor-pointer text-black ">
                                                            ...
                                                            <Link to={'/ecommerce-react-firebase/updateproduct'}>
